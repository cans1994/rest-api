 ...
 */
class Emprunteur extends ServiceEntityRepository
{
     ...
     */
    public function add(Emprunteur $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(Emprunteur $entity, bool $flush = true): void
    {
