 ...
 */
class Emprunt extends ServiceEntityRepository
{
     ...
     */
    public function add(Emprunt $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(Emprunt $entity, bool $flush = true): void
    {
